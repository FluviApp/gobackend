...
import StoreHeroRoutes from './routes/store/storeHeroRoute.js';
import StoreNotificationsRoutes from './routes/store/storeNotificationsRoute.js';
import StoreAnnouncementsRoutes from './routes/store/storeAnnouncementsRoute.js';
import StoreDeliveryConfigRoutes from './routes/store/storeDeliveryConfigRoute.js';
...
import ClientAnnouncementsRoutes from './routes/client/ClientAnnouncementsRoutes.js';
...
app.use('/api/store', StoreHeroRoutes);
app.use('/api/store', StoreNotificationsRoutes);
app.use('/api/store', StoreAnnouncementsRoutes);
app.use('/api/store', StoreDeliveryConfigRoutes);
...
app.use('/api/client/announcements', ClientAnnouncementsRoutes);
